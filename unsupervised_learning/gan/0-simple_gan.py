#!/usr/bin/env python3
"""
Implementation of a Simple Generative Adversarial
Network (GAN) using TensorFlow.

This module provides a Simple_GAN class
that implements a basic GAN architecture
...
class Simple_GAN(keras.Model):
    ...
    def __init__(self, generator, discriminator,
        ...
        Args:
            ...
            discriminator: Discriminator model that distinguishes real/fake
                samples
            latent_generator: Function that generates latent space vectors
